...
export default function ProjectCard({
  ...
  return (
    ...
    >
      <section className=" bg-gray-100 rounded-lg relative max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 sm:h-[20rem] sm:group-even:pl-8  hover:bg-gray-200 transition dark:bg-white/10 dark:hover:bg-white/20 ">
